...
const kitty = new Cat('cake', 7, 'gray');
console.log(kitty);
...
const partyPete = new Wizard('Party Pete', 550000, 'Fireball');
console.log(partyPete.castSpell());
...
const phone1 = new Phone('Apple', 'iPhone X', 64, 'Gray', 100);
const phone2 = new Phone('Apple', 'iPhone XR', 128, 'Red', 200);
const phone3 = new Phone('Apple', 'iPhone XS', 256, 'White', 300);
...
const myFirstVehicle = new Vehicle(5, 'white', 100);
...
const myFirstMotorcycle = new Motorcycle(1, 'Black', 5000, 'Honda', true);

/*
  Call the move function on myFirstMotorcycle (don't forget the parameter)
*/

myFirstMotorcycle.move(666);
...
const myFirstBoat = new Boat(5, 'White', 100, 'El Capitan', 'sail', false);
/*
